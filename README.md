...
> **Observação:** Nesta implementação, o projeto foi complementado com TypeScript para melhor tipagem e manutenção, além de melhorias em testes e organização.
...
1. Instale `nvm` (caso ainda não tenha) seguindo as instruções em:  
...
- Utilizar React.js (com extensão em TypeScript nesta versão) para o desenvolvimento do front-end.
...
1. Clone o repositório: `git clone https://github.com/vitorprestez/products-recommender.git`
...
- `test`: Executa os testes unitários com Jest (Necessário estar na pasta frontend).
...
Desenvolvido por **Vitor Prestes**
